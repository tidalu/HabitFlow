...
var ue = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  Yi = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of ql(t)) !jl.call(e, i) && i !== r && hr(e, i, { get: () => t[i], enumerable: !(n = Ul(t, i)) || n.enumerable })
    return e
  }
var Je = (e, t, r) => ((r = e != null ? Vl(Bl(e)) : {}), Yi(t || !e || !e.__esModule ? hr(r, 'default', { value: e, enumerable: !0 }) : r, e)),
...
function Ql(e) {
  let r = Object.getOwnPropertyNames(DataView.prototype).filter((a) => a.startsWith('get') || a.startsWith('set')),
    ...
    i = (a, m) =>
      function (f = 0) {
        return (G(f, 'offset'), se(f, 'offset'), W(f, 'offset', this.length - 1), new DataView(this.buffer)[r[a]](f, m))
      },
    o = (a, m) =>
      function (f, T = 0) {
...
var h,
  ...
  u = xe(() => {
    ...
    h = class e extends Uint8Array {
      ...
      readIntBE(t, r) {
        ;(G(t, 'offset'), se(t, 'offset'), W(t, 'offset', this.length - 1), G(r, 'byteLength'), se(r, 'byteLength'))
      ...
      writeUIntBE(t, r, n) {
        ;(G(r, 'offset'), se(r, 'offset'), W(r, 'offset', this.length - 1), G(n, 'byteLength'), se(n, 'byteLength'))
      ...
      fill(t = 0, r = 0, n = this.length, i = 'utf-8') {
        ...
        if (
          ...
          for (let a = o; a < s; a += t.length) super.set(t.slice(0, t.length + a >= this.length ? this.length - a : t.length), a)
        return this
      }
        ...
        return (
          ...
          s.length === 0 && i === !1
            ...
            : s.length === 0 && i === !0
              ...
              : o((m, f) => (i ? f <= a : f >= a) && this[f] === s[0] && s.every((S, v) => this[f + v] === S))
        )
      }
      toString(t = 'utf8', r = 0, n = this.length) {
        ...
        if (t === 'binary' || t === 'ascii' || t === 'latin1' || t === 'latin-1')
          return this.slice(r, n).reduce((i, o) => i + In(o & (t === 'ascii' ? 127 : 255)), '')
        if (t === 'ucs2' || t === 'ucs-2' || t === 'utf16le' || t === 'utf-16le') {
    ...
    ;((Hl = {
      ...
      (Gl = new TextEncoder()),
      (zl = new TextDecoder()),
      (Wl = ['utf8', 'utf-8', 'hex', 'base64', 'ascii', 'binary', 'base64url', 'ucs2', 'ucs-2', 'utf16le', 'utf-16le', 'latin1', 'latin-1']),
      (Kl = 4294967295))
    Ql(h.prototype)
    ;((g = new Proxy(Zl, {
      construct(e, [t, r]) {
...
function oo(e, t) {
  var r,
    ...
    T = e.constructor,
    S = T.precision
  if (!e.s || !t.s) return (t.s || (t = new T(e)), Q ? _(t, S) : t)
...
function so(e, t) {
  ...
  for (n = ((Math.log(He(2, f)) / Math.LN10) * 2 + 5) | 0, a += n, r = i = o = new T(le), T.precision = a; ; ) {
    if (((i = _(i.times(e), a)), (r = r.times(++m)), (s = o.plus(Oe(i, r, a))), Ee(s.d).slice(0, a) === Ee(o.d).slice(0, a))) {
...
function kn(e, t, r) {
  if (t > e.LN10.sd()) throw ((Q = !0), r && (e.precision = r), Error(pe + 'LN10 precision limit exceeded'))
...
function _(e, t, r) {
  ...
  if (((n = t - s), n < 0)) ((n += U), (i = t), (f = S[(T = 0)]))
  else {
    if (((T = Math.ceil((n + 1) / U)), (o = S.length), T >= o)) return e
    ...
    (r !== void 0 &&
      ...
      (m =
        r < 4
          ? (a || m) && (r == 0 || r == (e.s < 0 ? 3 : 2))
          : a > 5 ||
            (a == 5 && (r == 4 || m || (r == 6 && ((n > 0 ? (i > 0 ? f / He(10, s - i) : 0) : S[T - 1]) % 10) & 1) || r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !S[0])
  )
    return (
      m
        ? ((o = z(e)), (S.length = 1), (t = t - o - 1), (S[0] = He(10, (U - (t % U)) % U)), (e.e = ut(-t / U) || 0))
  ...
  if (
    (n == 0
      ? ((S.length = T), (o = 1), T--)
      : ((S.length = T + 1), (o = He(10, U - n)), (S[T] = i > 0 ? (((f / He(10, s - i)) % He(10, i)) | 0) * o : 0)),
    m)
  )
    for (;;)
      if (T == 0) {
...
function ze(e, t, r) {
  ...
  return (
    t
      ? (r && (n = r - s) > 0 ? (o = o.charAt(0) + '.' + o.slice(1) + _e(n)) : s > 1 && (o = o.charAt(0) + '.' + o.slice(1)),
        (o = o + (i < 0 ? 'e' : 'e+') + i))
      : i < 0
        ? ((o = '0.' + _e(-i - 1) + o), r && (n = r - s) > 0 && (o += _e(n)))
        : i >= s
          ? ((o += _e(i + 1 - s)), r && (n = r - i - 1) > 0 && (o = o + '.' + _e(n)))
          : ((n = i + 1) < s && (o = o.slice(0, n) + '.' + o.slice(n)), r && (n = r - s) > 0 && (i + 1 === s && (o += '.'), (o += _e(n)))),
    e.s < 0 ? '-' + o : o
  )
}
function no(e, t) {
...
var at,
  ...
  co = xe(() => {
    ...
    C.logarithm = C.log = function (e) {
      ...
      return r.eq(le) ? new n(0) : ((Q = !1), (t = Oe(Mt(r, o), Mt(e, o), o)), (Q = !0), _(t, i))
    }
    ...
    C.modulo = C.mod = function (e) {
      ...
      return r.s ? ((Q = !1), (t = Oe(r, e, 0, 1).times(e)), (Q = !0), r.minus(t)) : _(new n(r), i)
    }
    ...
    C.precision = C.sd = function (e) {
      ...
      if (((t = z(i) + 1), (n = i.d.length - 1), (r = n * U + 1), (n = i.d[n]), n)) {
        for (; n % 10 == 0; n /= 10) r--
    ...
    C.squareRoot = C.sqrt = function () {
      ...
      for (
        ...
        if (((o = n), (n = o.plus(Oe(a, o, s + 2)).times(0.5)), Ee(o.d).slice(0, s) === (t = Ee(n.d)).slice(0, s))) {
    ...
    C.toExponential = function (e, t) {
      ...
      return (
        e === void 0
          ? (r = ze(n, !0))
          : (Te(e, 0, at), t === void 0 ? (t = i.rounding) : Te(t, 0, 8), (n = _(new i(n), e + 1, t)), (r = ze(n, !0, e + 1))),
        r
      )
    }
    ...
    C.toPower = C.pow = function (e) {
      ...
      if (((t = e.e), (r = e.d.length - 1), (s = t >= r), (o = a.s), s)) {
        if ((r = T < 0 ? -T : T) <= io) {
          for (i = new m(le), t = Math.ceil(n / U + 4), Q = !1; r % 2 && ((i = i.times(a)), no(i.d, t)), (r = ut(r / 2)), r !== 0; )
            ((a = a.times(a)), no(a.d, t))
          return ((Q = !0), e.s < 0 ? new m(le).div(i) : _(i, n))
        }
      } else if (o < 0) throw Error(pe + 'NaN')
      return ((o = o < 0 && e.d[Math.max(t, r)] & 1 ? -1 : 1), (a.s = 1), (Q = !1), (i = e.times(Mt(a, n + f))), (Q = !0), (i = so(i)), (i.s = o), i)
    }
    ...
    Oe = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (m = n.e - i.e, ge = H.length, Qe = be.length, A = new yr($l), N = A.d = [], f = 0; H[f] == (be[f] || 0); ) ++f
        if ((H[f] > (be[f] || 0) && --m, o == null ? (j = o = yr.precision) : s ? (j = o + (z(n) - z(i)) + 1) : (j = o), j < 0)) return new yr(0)
        if (((j = (j / U + 2) | 0), (f = 0), ge == 1))
          for (T = 0, H = H[0], j++; (f < Qe || T) && j--; f++) (($ = T * K + (be[f] || 0)), (N[f] = ($ / H) | 0), (T = ($ % H) | 0))
        else {
          for (
            T = (K / (H[0] + 1)) | 0,
              T > 1 && ((H = e(H, T)), (be = e(be, T)), (ge = H.length), (Qe = be.length)),
              oe = ge,
              R = be.slice(0, ge),
              I = R.length;
            I < ge;
            ...
            R[I++] = 0
          ;((gr = H.slice()), gr.unshift(0), (Cn = H[0]), H[1] >= K / 2 && ++Cn)
          do
            ((T = 0),
              (a = t(H, R, ge, I)),
              a < 0
                ? ((J = R[0]),
                  ...
                  T > 1
                    ? (T >= K && (T = K - 1),
                      ...
                      (I = R.length),
                      (a = t(S, R, v, I)),
                      a == 1 && (T--, r(S, ge < v ? gr : H, v)))
                    : (T == 0 && (a = T = 1), (S = H.slice())),
                  (v = S.length),
                  v < I && S.unshift(0),
                  r(R, S, I),
                  a == -1 && ((I = R.length), (a = t(H, R, ge, I)), a < 1 && (T++, r(R, ge < I ? gr : H, I))),
                  (I = R.length))
                : a === 0 && (T++, (R = [0])),
              (N[f++] = T),
              a && R[0] ? (R[I++] = be[oe] || 0) : ((R = [be[oe]]), (I = 1)))
          while ((oe++ < Qe || R[0] !== void 0) && j--)
        }
        return (N[0] || N.shift(), (A.e = m), _(A, s ? o + z(A) + 1 : o))
      }
    })()
    lo = uo(Yl)
    le = new lo(1)
...
var No = ue((Ky, sc) => {
  sc.exports = {
    ...
    prisma: { enginesVersion: '3c6e192761c0362d496ed980de936e2f3cebcd3a' },
      ...
      for (var Qe = oe.length - 1; a < o - 3; )
        for (
          I = r.charCodeAt(s + (f = a)),
            ...
            j = r.charCodeAt(s + (S = a + 2)),
            $ = r.charCodeAt(s + (v = a + 3)),
            A = a += 4,
            m = 0;
          m < Qe;
          m += 2
          ...
          ((N = oe[m]),
            ...
            (f = N))
      for (; a < o; )
        for (I = r.charCodeAt(s + (f = a)), A = ++a, m = 0; m < Qe; m += 2) ((N = oe[m]), (oe[m] = A = e(N, f, A, I, oe[m + 1])), (f = N))
      return A
    }
  })()
})
...
var Ha = ue((B) => {
  ...
  var [wd, bd] = (0, nr.split)(ja, !0),
    Va = (e, t, r) => (r > 32 ? (0, nr.rotlBH)(e, t, r) : (0, nr.rotlSH)(e, t, r)),
    Ua = (e, t, r) => (r > 32 ? (0, nr.rotlBL)(e, t, r) : (0, nr.rotlSL)(e, t, r))
  function Qa(e, t = 24) {
  ...
  B.Keccak = ir
  var qe = (e, t, r) => (0, Me.wrapConstructor)(() => new ir(t, e, r))
  ...
  var Ja = (e, t, r) => (0, Me.wrapXOFConstructorWithOpts)((n = {}) => new ir(t, e, n.dkLen === void 0 ? r : n.dkLen, !0))
...
var eu = ue((Yk, Be) => {
  ...
  var Ka = (e = '') => Wa(xd(e)).toString(36).slice(1),
    Ga = Array.from({ length: 26 }, (e, t) => String.fromCharCode(t + 97)),
    Ed = (e) => Ga[Math.floor(e() * Ga.length)],
    Za = ({ globalObj: e = typeof globalThis < 'u' ? globalThis : typeof window < 'u' ? window : {}, random: t = Math.random } = {}) => {
    ...
    Ya = (e) => () => e++,
    Td = 476782367,
    Xa = ({ random: e = Math.random, counter: t = Ya(Math.floor(e() * Td)), length: r = za, fingerprint: n = Za({ random: e }) } = {}) =>
      function () {
        let o = Ed(e),
...
function ic(e) {
  let t = { color: Ao[nc++ % Ao.length], enabled: Ft.enabled(e), namespace: e, log: Ft.log, extend: () => {} },
    r = (...n) => {
...
function mt(e) {
  return qo.Decimal.isDecimal(e)
    ? !0
    : e !== null && typeof e == 'object' && typeof e.s == 'number' && typeof e.e == 'number' && typeof e.toFixed == 'function' && Array.isArray(e.d)
}
u()
l()
c()
...
var mc = Je(Fo())
var fc = { red: lt, gray: vo, dim: Er, bold: xr, underline: Tr, highlightSource: (e) => e.highlight() },
...
var Dr = (e) => e,
  ...
  Wo = { bold: xr, red: lt, green: Eo, dim: Er, enabled: !0 },
  gt = {
    write(e) {
      e.writeLine(',')
    }
...
var ht = class e extends $e {
  ...
  getDeepField(t) {
    ...
    for (let s of n) {
      let a
      if ((o.value instanceof e ? (a = o.value.getField(s)) : o.value instanceof yt && (a = o.value.getField(Number(s))), !a)) return
      o = a
    }
    return o
  }
  ...
  return o && m
    ...
    : ((m = s?.getField(n)),
      s && m
        ...
        : ((m = a?.getField(n)), a && m ? { parentKind: 'omit', field: m, parent: a, fieldName: n } : { parentKind: 'unknown', fieldName: n }))
}
function ts(e, t) {
...
function $r({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: m, args: f } = Fr(a, r),
    T = kr({ message: m, callsite: n, originalMethod: i, showColors: r === 'pretty', callArguments: f })
...
var Vr = class {
    ...
    clientExtensions = Lt(() =>
      this.extension.client ? { ...this.previous?.getAllClientExtensions(), ...this.extension.client } : this.previous?.getAllClientExtensions()
    )
    batchCallbacks = Lt(() => {
    ...
    getAllQueryCallbacks(t, r) {
      return this.queryCallbacksCache.getOrCreate(`${t}:${r}`, () => {
        ...
        return !o || !(o[t] || o.$allModels || o[r] || o.$allOperations)
          ? n
          : (o[t] !== void 0 && (o[t][r] !== void 0 && i.push(o[t][r]), o[t].$allOperations !== void 0 && i.push(o[t].$allOperations)),
            t !== '$none' &&
              o.$allModels !== void 0 &&
              (o.$allModels[r] !== void 0 && i.push(o.$allModels[r]), o.$allModels.$allOperations !== void 0 && i.push(o.$allModels.$allOperations)),
...
function Gc(e, t, r, n) {
  return e
    ? (t
        ...
        : r &&
          n.throwValidationError({ kind: 'MutuallyExclusiveFields', firstField: 'omit', secondField: 'select', selectionPath: n.getSelectionPath() }),
      Zc(e, n))
    : zc(n, t, r)
}
function zc(e, t, r) {
  let n = {}
  return (e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Wc(n, t, e), Kc(n, r, e), n)
}
function Wc(e, t, r) {
  for (let [n, i] of Object.entries(t)) {
    ...
    if (
      (s &&
        s.kind !== 'object' &&
        r.throwValidationError({ kind: 'IncludeOnScalar', selectionPath: r.getSelectionPath().concat(n), outputType: r.getOutputTypeDescription() }),
      s)
    ) {
      e[n] = Wt(i === !0 ? {} : i, o)
      continue
...
function zn(e, t) {
  e === void 0 &&
    t.isPreviewFeatureOn('strictUndefinedChecks') &&
    t.throwValidationError({ kind: 'InvalidSelectionValue', selectionPath: t.getSelectionPath(), underlyingError: gs })
}
var Gn = class e {
  constructor(t) {
    this.params = t
    this.params.modelName &&
      (this.modelOrType = this.params.runtimeDataModel.models[this.params.modelName] ?? this.params.runtimeDataModel.types[this.params.modelName])
  }
  modelOrType
  ...
  let r = rp(t),
    ...
    i = new Proxy(e, {
      ...
      getOwnPropertyDescriptor(o, s) {
        ...
        let m = r.get(s)
        return m ? (m.getPropertyDescriptor ? { ...Hr, ...m?.getPropertyDescriptor(s) } : Hr) : a
      },
...
var ks = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  Os = (e, t, r) => ks(t).reduceRight((n, i, o, s) => Object.assign({}, Yn(e, s.slice(0, o)), { [i]: n }), r)
function lp(e, t) {
...
function ei(e, t) {
  let r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [fp(e, t), yp(e, t), Zt(r), ie('name', () => t), ie('$name', () => t), ie('$parent', () => e._appliedParent)]
  return ye({}, n)
}
function fp(e, t) {
  let r = ve(t),
...
function Wr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
  ...
  let o = e(t, i, r) ?? t
  return (
    r.include && _s({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    r.select && _s({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    o
  )
}
...
function qs(e, t, r, n = 0) {
  return e._createPrismaPromise((i) => {
    ...
    return (
      'transaction' in t && i !== void 0 && (t.transaction?.kind === 'batch' && t.transaction.lock.then(), (t.transaction = i)),
      n === r.length
        ? e._executeRequest(t)
        : r[n]({
            model: t.model,
            ...
            query: (s, a = t) => {
              ...
              return ((a.customDataProxyFetch = Js(o, m)), (a.args = s), qs(e, a, r, n + 1))
            }
          })
    )
  })
...
function Gs({ dataPath: e, modelName: t, args: r, runtimeDataModel: n }) {
  ...
  for (let m of o) {
    ...
    if (!T) throw new Error(`Could not resolve relation field "${m}" on model "${s}" from dataPath "${e.join('.')}"`)
...
function he(e) {
  return JSON.stringify(e, (t, r) =>
    typeof r == 'bigint' ? r.toString() : ArrayBuffer.isView(r) ? g.from(r.buffer, r.byteOffset, r.byteLength).toString('base64') : r
  )
}
function Ap(e) {
...
var X = class extends Error {
  ...
  toQueryResponseErrorObject() {
    return { error: this.message, user_facing_error: { is_panic: !1, message: this.message, meta: this.meta, error_code: this.code } }
  }
}
function vt(e) {
  if (!Kr(e)) throw e
...
function ii(e) {
  throw Kr(e)
    ? new X(`Raw query failed. Code: \`${e.cause.originalCode ?? 'N/A'}\`. Message: \`${e.cause.originalMessage ?? ea(e)}\``, 'P2010', {
  ...
  return t.arguments.map((o) => {
    ...
    if (a === -1)
      return t.expectNonEmpty
        ? new X('An operation failed because it depends on one or more records that were required but not found', 'P2025')
        : null
    {
...
async function Yr({ query: e, tracingHelper: t, provider: r, onQuery: n, execute: i }) {
  ...
  return t.isEnabled()
    ? await t.runInChildSpan({ name: 'db_query', kind: tr.CLIENT, attributes: { 'db.query.text': e.sql, 'db.system.name': $p(r) } }, o)
    : o()
}
u()
l()
...
function _d(e, t = ou) {
  ...
  if (Number.isInteger(e) === !1) throw new rt(tt.EncodeTimeValueMalformed, `Time must be an integer: ${e}`)
  let r,
    n = ''
...
function Ud(e, t, r) {
  return (
    (e.msecs ??= -1 / 0),
    (e.seq ??= 0),
    t > e.msecs ? ((e.seq = (r[6] << 23) | (r[7] << 16) | (r[8] << 8) | r[9]), (e.msecs = t)) : ((e.seq = (e.seq + 1) | 0), e.seq === 0 && e.msecs++),
    e
  )
}
    ...
    switch (t.type) {
      ...
      case 'execute': {
        ...
        for (let o of n) {
          ...
          i += await this.#l(s, r.queryable, () => r.queryable.executeRaw(Li(s)).catch((a) => (t.args.type === 'rawSql' ? ii(a) : vt(a))))
        }
        return { value: i }
      }
      case 'query': {
        ...
        for (let o of n) {
          let s = yu(o, r.sqlCommenter),
            a = await this.#l(s, r.queryable, () => r.queryable.queryRaw(Li(s)).catch((m) => (t.args.type === 'rawSql' ? ii(m) : vt(m))))
      ...
      case 'mapRecord': {
        let { value: n, lastInsertId: i } = await this.interpretNode(t.args.expr, r),
          o = n === null ? {} : cr(n)
        for (let [s, a] of Object.entries(t.args.fields)) o[s] = nm(a, o[s], r.scope, r.generators)
...
var pr = class e {
  ...
  Ce = { ParamScalar: 1, ParamEnum: 2, ParamListScalar: 4, ParamListEnum: 8, ListObject: 16, Object: 32 },
  te = { String: 1, Int: 2, BigInt: 4, Float: 8, Decimal: 16, Boolean: 32, DateTime: 64, Json: 128, Bytes: 256 }
function Re(e, t) {
  return (e.flags & t) !== 0
}
function je(e) {
...
function Fi(e, t) {
  let r = new cn(t),
    ...
    i = t.root(n)
  return {
    parameterizedQuery: { ...e, query: r.parameterizeFieldSelection(e.query, i?.argsNodeId, i?.outputNodeId) },
...
var gm = 100,
  ...
  wm = () => ({ sql: '-- Implicit "COMMIT" query via underlying driver', args: [], argTypes: [] }),
  bm = () => ({ sql: '-- Implicit "ROLLBACK" query via underlying driver', args: [], argTypes: [] }),
  dr = class {
    ...
    async #r(t) {
      ...
      switch (
        ((r.transaction = await Promise.race([o.finally(() => clearTimeout(i)), Iu(n.signal, 'abort').then(() => {})])),
        this.transactions.set(r.id, r),
        r.status)
      ) {
        case 'waiting':
          if (n.signal.aborted)
            throw (o.then((s) => s.rollback()).catch((s) => Ot('error in discarded transaction:', s)), await this.#d(r, 'timed_out'), new mn())
      ...
      let n = async () => {
        ...
        try {
          if (t.transaction && r === 'committed')
            if (t.transaction.options.usePhantomQuery) await this.#f(wm(), t.transaction, () => t.transaction.commit())
            else {
              let i = ym()
            ...
            if (t.transaction.options.usePhantomQuery) await this.#f(bm(), t.transaction, () => t.transaction.rollback())
            else {
              let i = hm()
              try {
          ...
          ;((t.status = r),
            ...
            this.closedTransactions.length > gm && this.closedTransactions.shift())
        }
      }
      t.status === 'closing'
...
function Nu(e) {
  return typeof e == 'object' && e !== null && 'prisma__type' in e && typeof e.prisma__type == 'string' && e.prisma__type in Ou
    ? Ou[e.prisma__type]
    : typeof e == 'number'
      ? 'decimal'
      : typeof e == 'string'
...
var hn = class e {
  ...
  constructor(t, r, n) {
    ;((this.#e = t),
      ...
      (this.#i = lr.forSql({ onQuery: this.#e.onQuery, tracingHelper: this.#e.tracingHelper, provider: this.#e.provider, connectionInfo: this.#n })))
  }
...
function Qu(e) {
  ...
  if (n !== 'prisma:' && n !== Ar)
    throw new it('Error validating `accelerateUrl`: the URL must start with the protocol `prisma://` or `prisma+postgres://`', t)
  let o = i.get('api_key')
...
var Gu = ne('prisma:client:clientEngine:remoteExecutor'),
  Pn = class {
    ...
    async execute({ plan: t, placeholderValues: r, batchIndex: n, model: i, operation: o, transaction: s, customFetch: a, queryInfo: m }) {
    ...
    async #a(t, r) {
      ...
      throw new Hu.PrismaClientKnownRequestError(s, { clientVersion: this.#e, code: n ?? 'P6000', batchRequestIdx: r, meta: a })
    }
    #u(t) {
  ...
  qi = class {
    ...
    async request({ method: t, path: r, headers: n, body: i, fetch: o }) {
      ...
      return (Gu(t, s, m.status, m.statusText), (this.#r = m.headers.get('Accelerate-Query-Engine-Jwt') ?? void 0), this.#i(s, m), m)
    }
    #n(t) {
      let r = [],
        n = new Date()
      ...
      return (
        e.activeProvider === void 0 || Bi[e.activeProvider] === void 0
          ? ((n = (async () => {
              ...
              if (o == null)
                throw new ji.PrismaClientInitializationError('The loaded wasm module was unexpectedly `undefined` or `null` once loaded', t)
...
var mr = class {
  ...
  constructor(t, r) {
    ...
    else if (t.adapter) ((this.#n = { remote: !1, driverAdapterFactory: t.adapter }), Le('Using driver adapter: %O', t.adapter))
    else
    ...
    ;((this.#r = r ?? zu),
      ...
      (this.#i = t.queryPlanCacheMaxSize === 0 ? void 0 : new wn(t.queryPlanCacheMaxSize)),
  ...
  async #u() {
    return this.#n.remote
      ...
      : await hn.connect({
          ...
          tracingHelper: this.tracingHelper,
          transactionOptions: { ...this.config.transactionOptions, isolationLevel: this.#y(this.config.transactionOptions.isolationLevel) },
          onQuery: this.#s,
  ...
  async #l(t) {
    ...
    try {
      return this.#m(() => new r({ datamodel: this.datamodel, provider: n, connectionInfo: i }), void 0, !1)
    } catch (o) {
      throw this.#p(o)
    }
  }
...
${n.backtrace}`,
  ...
  #d(t) {
    return t instanceof re.PrismaClientRustPanicError
      ...
      : typeof t.message == 'string' && typeof t.code == 'string'
        ? new re.PrismaClientKnownRequestError(t.message, { code: t.code, meta: t.meta, clientVersion: this.config.clientVersion })
        : typeof t.message == 'string'
          ? new re.PrismaClientUnknownRequestError(t.message, { clientVersion: this.config.clientVersion })
          : t
  }
  #m(t, r, n = !0) {
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (Ku(t)) s = Zu(t)
      ...
      v ? (Le('query plan cache hit'), (s = v)) : (Le('query plan cache miss'), (s = this.#f(m, T, o)), S && this.#i?.setSingle(T, s))
    }
    try {
  ...
  async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
    ...
    if (T) S = this.#g(t, a, f)
      ...
      if (I) (Le('batch query plan cache hit'), (S = I))
      else {
      ...
      switch ((r?.kind === 'itx' && (A = r.options), S.type)) {
        case 'multi': {
          if (r?.kind !== 'itx') {
            let I = r?.options,
              J = {
                maxWait: I?.maxWait ?? this.config.transactionOptions.maxWait,
                timeout: I?.timeout ?? this.config.transactionOptions.timeout,
                isolationLevel: I?.isolationLevel ?? this.config.transactionOptions.isolationLevel
              }
            A = await this.transaction('start', {}, J)
          }
          let N = [],
            R = !1
          for (let [I, J] of S.plans.entries())
            try {
              let j = await m.execute({
                plan: J,
                placeholderValues: v,
                model: t[I].modelName,
        ...
        case 'compacted': {
          if (!t.every((I) => I.action === i && I.modelName === o)) {
            let I = t.map((j) => j.action).join(', '),
              J = t.map((j) => j.modelName).join(', ')
            throw new Error(
              `Internal error: All queries in a compacted batch must have the same action and model name, but received actions: [${I}] and model names: [${J}]. This indicates a bug in the client. Please report this issue to the Prisma team with your query details.`
            )
          }
          if (o === void 0)
            throw new Error(
  ...
  #y(t) {
    switch (t) {
      ...
      case 'Snapshot':
        return 'SNAPSHOT'
      default:
        throw new re.PrismaClientKnownRequestError(`Inconsistent column data: Conversion failed: Invalid isolation level \`${t}\``, {
          code: 'P2023',
          clientVersion: this.config.clientVersion,
  ...
  #h({ queries: t, execute: r }) {
    return this.tracingHelper.runInChildSpan(
      { name: 'compile', attributes: { models: t.map((n) => n.modelName).filter((n) => n !== void 0), actions: t.map((n) => n.action) } },
      r
    )
  }
}
...
var dl = {
  ...
  exports: {
    '.': { require: { types: './dist/index.d.ts', default: './dist/index.js' }, import: { types: './dist/index.d.mts', default: './dist/index.mjs' } }
  },
  license: 'Apache-2.0',
  homepage: 'https://www.prisma.io',
  repository: { type: 'git', url: 'https://github.com/prisma/prisma.git', directory: 'packages/instrumentation-contract' },
  bugs: 'https://github.com/prisma/prisma/issues',
  scripts: { dev: 'DEV=true tsx helpers/build.ts', build: 'tsx helpers/build.ts', prepublishOnly: 'pnpm run build', test: 'vitest run' },
  files: ['dist'],
  sideEffects: !1,
...
var Lm = ne('prisma:client:request_handler'),
  An = class {
      ...
      ;((this.logEmitter = r),
        ...
        (this.dataloader = new Sn({
          batchLoader: js(async ({ requests: n, customDataProxyFetch: i }) => {
            ...
            return (await this.client._engine.requestBatch(a, { traceparent: m, transaction: _m(o), containsWrite: f, customDataProxyFetch: i })).map(
              (S, v) => {
    ...
    handleRequestError({ error: t, clientMethod: r, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
      ...
      let m = t.message
      if (
        (n && (m = kr({ callsite: n, originalMethod: r, isPanic: t.isPanic, showColors: this.client._errorFormat === 'pretty', message: m })),
        ...
        if (t instanceof D.PrismaClientInitializationError) throw new D.PrismaClientInitializationError(m, this.client._clientVersion)
        if (t instanceof D.PrismaClientRustPanicError) throw new D.PrismaClientRustPanicError(m, this.client._clientVersion)
      }
...
var Tl = ['errorFormat', 'adapter', 'accelerateUrl', 'log', 'transactionOptions', 'omit', 'comments', 'queryPlanCacheMaxSize', '__internal'],
  ...
  Vm = {
    ...
    queryPlanCacheMaxSize: (e) => {
      if (e !== void 0) {
        if (typeof e != 'number')
          throw new F(`Invalid value ${JSON.stringify(e)} for "queryPlanCacheMaxSize" provided to PrismaClient constructor. Expected a number.`)
        if (!Number.isInteger(e))
          throw new F(`Invalid value ${e} for "queryPlanCacheMaxSize" provided to PrismaClient constructor. Expected an integer.`)
        if (e < 0)
          throw new F(
      ...
      if (e !== void 0) {
        ...
        for (let t = 0; t < e.length; t++)
          if (typeof e[t] != 'function')
            throw new F(`Invalid value at index ${t} for "comments" provided to PrismaClient constructor. Each plugin must be a function.`)
      }
    },
    __internal: (e) => {
      if (!e) return
      ...
      try {
        ...
        if (
          ...
          (this._engineConfig = {
            ...
            logQueries:
              s.log &&
              !!(typeof s.log == 'string' ? s.log === 'query' : s.log.find((f) => (typeof f == 'string' ? f === 'query' : f.level === 'query'))),
...
`,
    ...
    $executeRaw(n, ...i) {
      return this._createPrismaPromise((o) => {
        if (n.raw !== void 0 || n.sql !== void 0) {
          let [s, a] = Ol(n, i)
          return (
            Qi(this._activeProvider, s.text, s.values, Array.isArray(n) ? 'prisma.$executeRaw`<SQL>`' : 'prisma.$executeRaw(sql`<SQL>`)'),
    ...
    $executeRawUnsafe(n, ...i) {
      return this._createPrismaPromise(
        (o) => (
          Qi(this._activeProvider, n, i, 'prisma.$executeRawUnsafe(<SQL>, [...values])'),
    ...
    $runCommandRaw(n) {
      if (e.activeProvider !== 'mongodb')
        throw new D.PrismaClientValidationError(`The ${e.activeProvider} provider does not support $runCommandRaw. Use the mongodb provider.`, {
          clientVersion: this._clientVersion
        })
    ...
    $queryRawTyped(n) {
      return this._createPrismaPromise((i) => {
        if (!this._hasPreviewFlag('typedSql'))
          throw new D.PrismaClientValidationError('`typedSql` preview feature must be enabled in order to access $queryRawTyped API', {
            clientVersion: this._clientVersion
          })
    ...
    async _transactionWithCallback({ callback: n, options: i = {} }) {
      ...
      try {
        ...
        for (let J = 0; J < I; J++)
          await this._engine.transaction('rollback', T, v).catch((j) => {
      ...
      typeof n == 'function'
        ? this._engineConfig.adapter?.adapterName === '@prisma/adapter-d1'
          ...
          : e.activeProvider === 'mongodb' && kl(this).kind === 'nested'
            ? (o = () => {
                throw new D.PrismaClientValidationError(`The ${e.activeProvider} provider does not support nested transactions`, {
                  clientVersion: this._clientVersion
                })
              })
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? Qm,
        ...
        s = {
          operation: { name: 'operation', attributes: { method: o.action, model: o.model, name: o.model ? `${o.model}.${o.action}` : o.action } }
        },
        a = async (m) => {
          let { runInTransaction: f, args: T, ...S } = m,
            v = { ...n, ...S }
          ;(T && (v.args = i.middlewareArgsToRequestArgs(T)), n.transaction !== void 0 && f === !1 && delete v.transaction)
